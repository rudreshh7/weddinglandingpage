  ...
  return (
    <div>
      ...
      <div className="story-blog">
        <p>
          Veerali and Michale's love story is a testament to the strength of
          ...
          girl and French boy who wasted no time in asking the former out on a
          first date.
        </p>
        <p>
          Despite the physical distance that separated them, Veerali and Michale
        ...
        <p>
          As they tied the knot, Veerali and Michale embarked on a new adventure
        ...
        <p>
          Here's to Veerali and Michale, and the many more chapters of their
      ...
      <h6 className="stories-heading-section">THE WEDDING</h6>
...
export default VeeraliAndMichale;
